...
#ifndef _MA35D0_AUDIO_H
#define _MA35D0_AUDIO_H
...
int ma35d0_dma_create(struct ma35d0_audio *ma35d0_audio);
int ma35d0_dma_destroy(struct ma35d0_audio *ma35d0_audio);

#define DRV_NAME "ma35d0-dai"

#endif /*end _MA35D0_AUDIO_H */
