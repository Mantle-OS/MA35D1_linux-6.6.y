...
static unsigned long ma35h0_pll_frac_mode_find_closest(struct ma35h0_clk_pll *pll,
...
unsigned long CLK_SetPLLFreq(struct ma35h0_clk_pll *pll, unsigned long PllSrcClk,
			     unsigned long u64PllFreq)
{
	...
	case VSIPLL_SS_MODE:
		u64PllClk = ma35h0_pll_frac_mode_find_closest(pll, u64PllFreq,
							      PllSrcClk, u32Reg,
							      &u64PllClk);
		val_ctl0 = u32Reg[0];
		break;
...
unsigned long CLK_GetPLLFreq_VSIPLL(struct ma35h0_clk_pll *pll, unsigned long PllSrcClk)
{
