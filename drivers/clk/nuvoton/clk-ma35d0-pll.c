...
unsigned long CLK_SetPLLFreq(struct ma35d0_clk_pll *pll, unsigned long PllSrcClk,
...
unsigned long CLK_GetPLLFreq_VSIPLL(struct ma35d0_clk_pll *pll, unsigned long PllSrcClk)
{
